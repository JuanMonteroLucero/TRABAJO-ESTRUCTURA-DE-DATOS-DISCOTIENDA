...
public class Discotienda
{
     ...
     */
    public void generarInformeDiscosCostosos(String uGenero) throws FileNotFoundException, IOException
    {
    	int existeGenero = 0;
    	int existeDiscosCostosos = 0;
    	...
    	for (int i = 0; i<discos.size(); i++) {
    		...
    		// Evaluar si existe el género dado por el usuario
    		if (miDisco.darGenero().equals(uGenero)) {
    			existeGenero++;
    	    // Evaluar si existe discos que superen los 1000
    			if (miDisco.darPrecioDisco()>1000) {
    				existeDiscosCostosos++;
    			}
    		}
    	}
    	// Excepciones
    	...
    	for (int i = 0; i<discos.size(); i++) {
    		...
    		// Evaluar el género dado por el usuario
    		if (miDisco.darGenero().equals(uGenero)) {
    			if (miDisco.darPrecioDisco()>1000) {
    				...
    				pluma.println("Género: " + miDisco.darGenero());
    				pluma.println("-----------------------------------");
    			}
    		}
    	}
 ...
 */
    ...
    public void generarInformeDiscos() throws FileNotFoundException{
    	...
    	pluma.println("-----------------");
    	// Reporrte de discos con nombre, artistas y genero
    ...
    public String metodo2( )
    {
    	try {
    		String mensaje = "";
    		String usuario = JOptionPane.showInputDialog(null, "Ingrese el género", "Discos Costosos", JOptionPane.QUESTION_MESSAGE);
    		if (usuario != null) {
